                ...
                <div class="container-fluid custom-container">
                    <div class="header-nav-wrapper d-flex justify-content-between">
                        ...
                        <div class="header-menu-nav">
                            <ul class="menu-nav">
                                <li><a href="compare"><i class="fal fa-repeat"></i> Compare (0)</a></li>
                                <li><a href="wishlist"><i class="fal fa-heart"></i> Wishlist(0)</a></li>
                                <li>
                                    <div class="dropdown">
                                    ...
                                    <div class="mini-cart">
                                        <ul class="cart-items">
                                            <li>
                                                <div class="single-cart-item d-flex">
                                                    <div class="cart-item-thumb">
                                                        <a href="single-product"><img src="assets/images/product-cart/cart-1.jpg" alt="product"></a>
                                                        <span class="product-quantity">1x</span>
                                                    </div>
                                                    <div class="cart-item-content media-body">
                                                        <h5 class="product-name"><a href="single-product">New Balance Fresh Foam LAZR</a></h5>
                                            ...
                                            <li>
                                                <div class="single-cart-item d-flex">
                                                    <div class="cart-item-thumb">
                                                        <a href="single-product"><img src="assets/images/product-cart/cart-2.jpg" alt="product"></a>
                                        ...
                                        <div class="checkout text-center">
                                            <a href="checkout" class="main-btn">Checkout</a>
                                        </div>
                                    </div> <!-- mini cart -->
                                </div>
                                        ...
                                        <ul class="sub-menu flex-wrap">
                                            <li>
                                                ...
                                                <ul class="submenu-item ">
                                                    <li><a href="shop-left-sidebar">Dresses</a></li>
                                                    <li><a href="shop-left-sidebar">Jackets & Coats</a></li>
                                                    <li><a href="shop-left-sidebar">Sweaters</a></li>
                                                    <li><a href="shop-left-sidebar">Jeans</a></li>
                                                    <li><a href="shop-left-sidebar">Blouses & Shirts</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><span>Outerwear & Jackets</span></a>
                                                <ul class="submenu-item ">
                                                    <li><a href="shop-left-sidebar">Basic Jackets</a></li>
                                                    <li><a href="shop-left-sidebar">Real Fur</a></li>
                                                    <li><a href="shop-left-sidebar">Down Coats</a></li>
                                                    <li><a href="shop-left-sidebar">Blazers</a></li>
                                                    <li><a href="shop-left-sidebar">Trench Coats </a></li>
                                                </ul>
                                            </li>
                                            <li>
                                    ...
                                    <li class="menu-item">
                                        ...
                                        <ul class="sub-menu flex-wrap">
                                            <li>
                                                ...
                                                <ul class="submenu-item ">
                                                    <li><a href="shop-left-sidebar">Cables & Adapters</a></li>
                                                    <li><a href="shop-left-sidebar">Batteries</a></li>
                                                    <li><a href="shop-left-sidebar">Chargers</a></li>
                                                    <li><a href="shop-left-sidebar">Bags & Cases</a></li>
                                                    <li><a href="shop-left-sidebar">Electronic Cigarettes</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><span>Audio & Video</span></a>
                                                <ul class="submenu-item ">
                                                    <li><a href="shop-left-sidebar">Televisions</a></li>
                                                    <li><a href="shop-left-sidebar">TV Receivers</a></li>
                                                    <li><a href="shop-left-sidebar">Projectors</a></li>
                                                    <li><a href="shop-left-sidebar">Audio Amplifier Boards</a></li>
                                                    <li><a href="shop-left-sidebar">TV Sticks </a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><span>Camera & Photo</span></a>
                                                <ul class="submenu-item ">
                                                    <li><a href="shop-left-sidebar">Digital Cameras</a></li>
                                                    <li><a href="shop-left-sidebar">Camcorders</a></li>
                                                    <li><a href="shop-left-sidebar">Camera Drones</a></li>
                                                    <li><a href="shop-left-sidebar">Action Cameras</a></li>
                                                    <li><a href="shop-left-sidebar">Photo Studio Supplies </a></li>
                                                </ul>
                                            </li>
                                        </ul> <!-- sub menu -->
                                    </li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Smartphone</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Game Consoles</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Mp3 & headphone</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Tv & Video</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Watches</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Watches</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Washing Machine</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Camera</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Audio & Theater</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Accessories</a></li>
                                    <li class="menu-item"><a href="shop-left-sidebar">Games & Consoles</a></li>
                                </ul> <!-- menu content -->
                                    ...
                                    <li class="position-static"><a href="#">Shop <i class="fal fa-chevron-down"></i></a>
                                        <ul class="mega-sub-menu d-flex flex-wrap">
                                            <li>
                                                ...
                                                <ul class="submenu-item">
                                                    <li><a href="shop-3-column">Shop Grid Column 3</a></li>
                                                    <li><a href="shop-4-column">Shop Grid Column 4</a></li>
                                            ...
                                            <li>
                                                ...
                                                <ul class="submenu-item">
                                                    ...
                                                    <li><a href="single-product-tabstyle2">Shop Tabs 2</a></li>
                                                    <li><a href="single-product-tabstyle3">Shop Tabs 3</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a class="menu-title" href="#">Shop Single</a>
                                                <ul class="submenu-item">
                                                    ...
                                                    <li><a href="single-product-gallery-left">Shop Gallery Left sidebar</a></li>
                                                    <li><a href="single-product-gallery-right">Shop Gallery Right sidebar</a></li>
                                                    <li><a href="single-product-sticky-left">Shop Sticky Left sidebar</a></li>
                                                    <li><a href="single-product-sticky-right">Shop Sticky Right sidebar</a></li>
                                                </ul>
                                            </li>
                                            <li class="custom-banner">
                                                <a href="shop-4-column"><img src="assets/images/custom_banner.jpg" alt="" class="img-responsive"></a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="#">Blog <i class="fal fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="#">Blog Grid <i class="fal fa-chevron-right"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="blog-grid-left-sidebar">Blog Grid Left Slider</a></li>
                                                    <li><a href="blog-grid-right-sidebar">Blog Grid Right Slider</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Blog List <i class="fal fa-chevron-right"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="blog-list-left-sidebar">Blog List Left Slider</a></li>
                                                    <li><a href="blog-list-right-sidebar">Blog List Right Slider</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Blog Single <i class="fal fa-chevron-right"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="blog-single-left-sidebar">Blog Single Left Slider</a></li>
                                                    <li><a href="blog-single-right-sidebar">Blog Single Right Slider</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <div class="mobile-off-canvas-menu">
                ...
                <div class="mobile-main-menu">
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a href="shop-left-sidebar">Smartphone</a></li>
                        <li><a href="shop-left-sidebar">Game Consoles</a></li>
                        <li><a href="shop-left-sidebar">Mp3 & headphone</a></li>
                        <li><a href="shop-left-sidebar">Tv & Video</a></li>
                        <li><a href="shop-left-sidebar">Watches</a></li>
                        <li><a href="shop-left-sidebar">Watches</a></li>
                        <li><a href="shop-left-sidebar">Washing Machine</a></li>
                        <li><a href="shop-left-sidebar">Camera</a></li>
                        <li><a href="shop-left-sidebar">Audio & Theater</a></li>
                        <li><a href="shop-left-sidebar">Accessories</a></li>
                        <li><a href="shop-left-sidebar">Games & Consoles</a></li>
                    </ul> <!-- menu content -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="login-register-wrapper mt-30">
                        <h4 class="allup-title">找回密码</h4>
                        <p class="mt-10">如果您不需要找回密码了，可以点击这里 <a href="login">登录</a></p>

                        <form action="#">
                            <div class="single-form">
                                <input type="text" placeholder="注册时填写的邮箱">
                            </div>
                            <div class="single-form">
                            ...
                            <div class="single-form">
                                <button class="main-btn main-btn-2">设置新密码</button>
                            </div>
                        </form>                        
                    </div>
                </div>

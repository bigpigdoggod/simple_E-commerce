...
public class DBUtils2 {
	...
	private static final String URL = "jdbc:mysql://i.8buff.com:3306/pinxixi?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false&allowPublicKeyRetrieval=true";
	private static final String USER = "root";
	//private static final String PASSWORD = "167943qead";
	private static final String PASSWORD = "TrevorPhillips";
	 ...
	 * @return
	 */
	public static <T> List<T> query(String sql, List<Object> params, Class<T> cls) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			while (rs.next()) {
				...
				for (int i = 0; i < rsd.getColumnCount(); i++) {
					//String col_name = toLowerCaseFirstOne(rsd.getColumnName(i + 1));// 获得列名
